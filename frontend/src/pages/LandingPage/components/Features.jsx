...
import { employersFeatures, jobSeekersFeatures } from '../../../utils/data'
            ...
            <div className='grid  md:grid-cols-2 gap-16 lg:gap-24'>
                ...
                <div>
                    <div className='text-center mb-12'>
                        ...
                        <div className='w-24 h-1 bg-linear-to-r from-blue-500 to-blue-600 mx-auto rounded-b-full' />
                    </div>
                ...
                <div>
                    <div className='text-center mb-12'>
                        ...
                        <div className='w-24 h-1 bg-linear-to-r from-purple-500 to-purple-600 mx-auto rounded-b-full' />
                    </div>
