...
function ManageJobs() {
  ...
  //Decide which status badge to show
      ...
      <div className="min-h-screen p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold rounded-xl hover:from-blue-700 hover:to-blue-800 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
              >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            ...
            {/*Jobs Table*/}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border-white/20 overflow-hidden">
              {filteredAndSortedJobs.length === 0 && !isLoading ? (
                ...
                <div className="w-full md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-linear-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        <th
                          className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-0"
                        ...
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-0">
                          Actions
                        </th>
                      </tr>
                    </thead>
                    ...
                    : paginatedJobs.map((job) => (
                      ...
                      >
                        <td className="px-6 py-6 sm:whitespace-nowrap min-w-0">
                          <div>
                        ...
                        <td className="px-6 py-5 sm:whitespace-nowrap min-w-0">
                          <span
                        ...
                        <td className="px-6 py-4 sm:whitespace-nowrap text-sm font-medium min-w-0">
                          <div className="flex space-x-2">
                            <button
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                <button
                  ...
                  disabled={currentPage === 1}
                  className="relative inline-flex items-center px-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
                ...
                <button
                  onClick={() => setCurrentPage(Math.min(totalPages, currentPage +1))}
                  disabled={currentPage === totalPages}
                  className="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white font-medium text-sm text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Next
                </button>
              </nav>
