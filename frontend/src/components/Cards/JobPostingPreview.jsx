  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto'>
            ...
            <div className='mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 py-6'>
                <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-4'>
                        <h2 className='text-lg md:text-xl font-bold bg-linear-to-r from-gray-900 to-gray-600 text-transparent bg-clip-text'>
                            Job Preview
                        </h2>
                    </div>
                    <button
                                    ...
                                    <div className='flex items-center space-x-3'>
                                        ...
                                        <div>
                                            ...
                                            <div className='text-sm md:text-lg font-bold text-gray-900'>
                                                {
                                                    currencies.find(c => c.value === formData.salaryCurrency)?.label
                                                }
